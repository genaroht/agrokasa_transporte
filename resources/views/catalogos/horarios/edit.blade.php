...
<div class="bg-white rounded-lg shadow p-4 max-w-xl">
    <form method="POST" action="{{ route('catalogos.horarios.update', $horario) }}" class="space-y-3">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="nombre" value="{{ old('nombre', $horario->nombre) }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
                ...
                <input type="time" name="hora"
                       value="{{ old('hora', $horario->hora_formateada) }}"
                       class="w-full rounded border-gray-300 focus:border-[#007037] focus:ring-[#007037]" required>
            </div>
            ...
            <div>
                ...
                <input type="time" name="hora_fin"
                       value="{{ old('hora_fin', $horario->hora_fin_formateada) }}"
                       class="w-full rounded border-gray-300 focus:border-[#007037] focus:ring-[#007037]">
            </div>
        </div>
        ...
        <div class="flex items-center gap-2">
            <input type="checkbox" name="activo" value="1" id="activo"
                   class="rounded border-gray-300" @checked(old('activo', $horario->activo))>
